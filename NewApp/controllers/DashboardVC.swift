...
class DashboardVC: UIViewController {
    ...
    lazy var logoView: UILabel = {
        ...
        var attributedString = NSMutableAttributedString(string: "OTOS", attributes: [NSAttributedString.Key.foregroundColor:UIColor.white,NSAttributedString.Key.font:UIFont.systemFont(ofSize: 28)])
        attributedString.append(NSAttributedString(string: "\nHow may i help you? ", attributes: [NSAttributedString.Key.foregroundColor:UIColor.white,NSAttributedString.Key.font:UIFont.systemFont(ofSize: 26)]))
