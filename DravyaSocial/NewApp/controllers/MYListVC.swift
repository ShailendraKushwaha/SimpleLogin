...
class MYListVC: UIViewController {
   ...
   lazy var plusButton:UIButton = {
    ...
    let urlForUsers = "https://s3-ap-southeast-1.amazonaws.com/he-public-data/users49b8675.json"
...
//        }
    ...
    private func fetchOnlineData(){
        
        APIHandler.sharedInstance.getAPI(url: self.urlForUsers, onSuccess: {response in
