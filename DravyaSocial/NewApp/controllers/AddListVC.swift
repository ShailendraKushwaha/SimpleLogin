...
class AddListVC: UIViewController {
    ...
    lazy var nameField:UITextField = {
        let textField = UITextField()
        textField.translatesAutoresizingMaskIntoConstraints = false
        textField.placeholder = "Name of Persone"
        textField.borderStyle = .none
        textField.autocapitalizationType = .none
        textField.delegate =  self
        return textField
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        createAccountButton.topAnchor.constraint(equalTo: emailInputContainer.bottomAnchor,constant: 32).isActive = true
    ...
    @objc public func createAccountTapped(sender:Any) {
        ...
        item.setValue(nameField.text!, forKey: "name")
        item.setValue(emailTextField.text!, forKey: "image")
        item.setValue(String(Int.random(in: 0 ..< 100000)), forKey: "id")
//        item.setValue(emailTextField.text!, forKey: "image")
        print("Storing Data..")
                do {
                    try context.save()
